...
const GalleryHighestRated: React.FC<{ highestRatedMotofy: IMotofy }> = ({
  highestRatedMotofy,
}) => {
  const motofy = { ...highestRatedMotofy };
  // console.log("highestMotofy", highestRatedMotofy);
...
export default GalleryHighestRated;
