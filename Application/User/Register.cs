...
namespace Application.User
{
    public class Register
    {
        ...
        public class CommandValidator : AbstractValidator<Command>
        {
            ...
            {
                RuleFor(x => x.DisplayName).NotEmpty().MinimumLength(3).WithMessage("DisplayName must be at least 3 characters");
            ...
            public class Handler : IRequestHandler<Command>
            {
                ...
                public Handler(IEmailSender emailSender, DataContext context, UserManager<AppUser> userManager)
                {
